...
public class UserDaoImpl implements UserDao {
    ...
    public String insertUser(UserEntity user) {
        ...
        try {
            ...
            e.printStackTrace();
            result = "用户：" + user.getUserName() + " 注册失败：" + e;
        }
    ...
    public List<UserEntity> queryInfo(String type, Object value) {
        String sql = "from wiseking.test.entity.UserEntity as user where user." + type + "=?";
    ...
    private void showMessage(String mess) {
        /*
         * int type = JOptionPane.YES_NO_OPTION; String title = "提示信息";
